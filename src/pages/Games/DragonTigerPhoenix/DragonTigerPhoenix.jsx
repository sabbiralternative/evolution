      ...
      <div id="root" className="rootContainer--308ad">
        <div className="container--efd24">
          ...
          >
            ...
            <div style={{ width: "430px", height: "322.5px", margin: "auto" }}>
              <div
                ...
                style={{
                  ...
                  transform: "scale(1.33333, 1.33333) translate(0px, 0px)",
                }}
              >
                <div
                        ...
                        <div style={{ height: "100%" }}>
                          <div style={{ width: "100%", height: "100%" }}>
                            <video
                              ...
                              src="blob:https://babylonbetst.evo-games.com/ae67f6cd-ea48-47ba-a346-80924d0c11d0"
                            />
                            <canvas
                              width={0}
                              height={0}
