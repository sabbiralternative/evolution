...
const BetSlip = ({
  ...
  const handleStakeChange = (payload) => {
    if (status === Status.OPEN) {
      handleStoreRecentPlay(username, eventId, "baccarat");
          ...
          <div className="mainContainer--2572f">
            ...
            >
              ...
              <div className="title--967a1">
                <div className="titleContainer--98fa0">Player</div>
              </div>
            ...
            >
              ...
              <div className="title--967a1">
                <div className="titleContainer--98fa0">Banker</div>
              </div>
              {/* <div className="liveStatisticsContainer--fc00f">
                <div
            ...
            >
              <svg
                ...
                className={cn(
                  ...
                  isRunnerWinner(data, 4, 2) && "animate-win",
