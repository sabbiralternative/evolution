      ...
      <div id="root" className="rootContainer--308ad">
        <div className="container--efd24">
          ...
          >
            ...
            <div
              style={{ width: "430px", height: "432.956px", margin: "auto" }}
            >
              <div
                ...
                style={{
                  ...
                  transform: "scale(1.79, 1.79) translate(0px, 0px)",
                }}
              >
                <div
                        ...
                        <div style={{ height: "100%" }}>
                          <div style={{ width: "100%", height: "100%" }}>
                            <video
                              ...
                              src="blob:https://babylonbetst.evo-games.com/eecfd2d5-2f2d-4907-bf68-c6f5721a147a"
                            />
                            <canvas
                              width={0}
                              height={0}
