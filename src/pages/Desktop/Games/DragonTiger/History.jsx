const History = ({ recentWinner }) => {
  return (
    <div className="top-right--83089">
      <div className="box--28913">
        <div
          className="topRightEntertainment--8a4fe"
          data-role="classic-top-right"
        >
          <div
            className="historyStatistic--92a75 fourLines--dba5d"
